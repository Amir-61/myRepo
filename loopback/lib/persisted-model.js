...
module.exports = function(registry) {
  ...
  PersistedModel.upsertWithWhere  = function upsertWithWhere(where, data, callback) {
  ...
  PersistedModel.setupRemoting = function() {
    ...
    setRemoting(PersistedModel, 'upsertWithWhere', {
      aliases: ['upsertWithWhere'],
      description: 'Update an existing model instance or insert a new one into the data source based on the non-primary ' +
      'key filter.',
      accessType: 'WRITE',
      accepts: [
